...
* **🧠 多模态并发创作**：输入一次产品信息，即可根据各平台算法特性（微信公众号、LinkedIn、Twitter、Facebook、Instagram 等）并发生成专属风格的营销文案、配套视觉提示词（Prompt）以及短视频文案（Caption）。
...
#### 1. 克隆项目
```bash
git clone https://github.com/Sayo88/contentflow-ai-agent.git
